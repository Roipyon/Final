...
// 获取年级信息
app.get('/admin/grades',isAdmin,async(req,res)=>{
    try {
...
// 获取特定班级的所有学生信息
app.get('/admin/classes/:classId/students',isAdmin,async(req,res)=>{
...
// 添加学生到班级（补录）
app.post('/admin/classes/:classId/students',isAdmin,async(req,res)=>{
    const classId = parseInt(req.params.classId);
...
// 添加教师（教务主任权限）
app.post('/admin/teachers',isAdmin,async(req,res)=>{
    const { name } = req.body;
    if (!name) {
...
// 删除班级成员
app.delete('/admin/classes/:classId/students/:studentId',isAdmin,async(req,res)=>{
    const classId = parseInt(req.params.classId);
...
app.put('/admin/classes/:classId/teacher',isAdmin,async(req,res)=>{
    const classId = parseInt(req.params.classId);
...
// 修改班级名称
app.put('/admin/classes/:classId',isAdmin,async(req,res)=>{
    const classId = parseInt(req.params.classId);
...
// 删除班级（会删除班级成员关系）
app.delete('/admin/classes/:classId',isAdmin,async(req,res)=>{
    const classId = parseInt(req.params.classId);
    try {
...
// 新增班级
app.post('/admin/classes',isAdmin,async(req,res)=>{
    const { className, gradeId } = req.body;
...
// 获取科目满分（管理员）
app.post('/admin/fullmark',isAdmin,async(req,res)=>{
...
// 添加成绩
app.post('/admin/scores',isAdmin,async(req,res)=>{
...
// 修改成绩
app.put('/admin/scores/:id',isAdmin,async(req,res)=>{
...
// 删除分数
app.delete('/admin/scores/:id',isAdmin,async(req,res)=>{
    const scoreId = parseInt(req.params.id);
    try {
